...
type ResourceConfig struct {
	...
	EnableExporterHealthCheck bool                      `json:"enableExporterHealthCheck,omitempty"`
	DisableDeviceConfig       bool                      `json:"disableDeviceConfig,omitempty"`
...
type ResourcePool interface {
	...
	GetCDIName() string
	EnableExporterHealthCheck() bool
	DisableDeviceConfig() bool
}

...
// EnableExporterHealthCheck provides a mock function with no fields
func (_m *ResourcePool) EnableExporterHealthCheck() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for EnableExporterHealthCheck")
	}
...
// DisableDeviceConfig provides a mock function with no fields
func (_m *ResourcePool) DisableDeviceConfig() bool {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for DisableDeviceConfig")
	}

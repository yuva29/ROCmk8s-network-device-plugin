...
func (rp *ResourcePoolImpl) EnableExporterHealthCheck() bool {
	return rp.config.EnableExporterHealthCheck
}

func (rp *ResourcePoolImpl) DisableDeviceConfig() bool {
	return rp.config.DisableDeviceConfig
}

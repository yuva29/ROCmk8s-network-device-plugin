...
| image | object | `{"initContainerImage":"busybox:1.36","pullPolicy":"IfNotPresent","repository":"docker.io/rocm/k8s-network-device-plugin","tag":"v1.1.0"}` | Container image configuration |
